...
'    uNumberXFiles = 0
'    uZipFileName = g_IDILocation & "MESSAGES\TEMP\" & g_ParentCompany & ".zip"
'    uExtractDir = g_IDILocation & "RCV1"
'    uVbSkip = 0
'    Call VBUnZip32
'    Set fso = CreateObject(Scripting.FileSystemObject)
'    Set txtfile = fso.GetFile(g_IDILocation & "MESSAGES\TEMP\" & g_ParentCompany & ".zip")
'    txtfile.Delete
...
Public Function UZDLLPass(ByRef p As UNZIPCBCh, _
  ...
  szpassword = InputBox("What is your password?")
...
Public Sub VBUnZip32()
  ...
  If retcode <> 0 And retcode <> 9 Then MsgBox retcode
